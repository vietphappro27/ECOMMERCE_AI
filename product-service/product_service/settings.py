...
SECRET_KEY = 'django-insecure-@2i6hit046d1w^u=%v^hy9u&gtj+)xs)f)hmvm1!jf5hj)jk5*'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_POSTGRES_NAME', 'ktra1_product_db'),
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'http://customer-service:8001',
    'http://staff-service:8002',
    'http://product-service:8003',
    'http://ai-service:8005',
]